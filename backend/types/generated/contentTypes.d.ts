...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'KI-News-Artikel, siehe ARCHITECTURE.md Content-Modell';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    aiGenerated: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    editorsNote: Schema.Attribute.Text;
    editorsPick: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    humanReviewed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '7 Hauptkategorien lt. PROJEKTPLAN.md';
...
export interface ApiSourceSource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'RSS/API-Quellen f\u00FCr die Ingestion-Pipeline, siehe data/sources.json';
    displayName: 'Source';
    pluralName: 'sources';
    singularName: 'source';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    refreshIntervalMinutes: Schema.Attribute.Integer &
